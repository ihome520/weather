...
[![Build Status](https://travis-ci.org/ihome/weather.svg?branch=master)](https://travis-ci.org/ihome/weather) 
[![StyleCI build status](https://github.styleci.io/repos/144818004/shield)](https://github.styleci.io/repos/144818004)

## 安装

```sh
$ composer require ihome/weather -vvv
```
...
可以用两种方式来获取 `ihome\Weather\Weather` 实例：
